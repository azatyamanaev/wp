...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
    ...
    <tr>
        <td bgcolor="#f7f7f7" style="padding: 40px 30px 40px 30px;">
            <p>Dear, ${name} </p>
            <p>Please click the following button to confirm your email</p>
            </br>
            <div style="text-align: center;">
                <a type="button" class="button" href="http://localhost:8080/confirming?token=${token}" style="background-color: black; color: white">Confirm</a>
            </div>
        </td>
    </tr>
</table>
